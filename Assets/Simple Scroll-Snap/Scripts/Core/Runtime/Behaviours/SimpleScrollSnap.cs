...
{
    public class TransitionProcess : UnityEvent<GameObject, float>
    {

    }

    public class PanelProcess : UnityEvent<int>
    {

    }

    public class PanelCenter : UnityEvent<int, int>
    {
    ...
    public class SimpleScrollSnap : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        // Events
        [SerializeField] private TransitionProcess onTransitionEffects = new TransitionProcess();
        [SerializeField] private PanelProcess onPanelSelecting = new PanelProcess();
        [SerializeField] private PanelProcess onPanelSelected = new PanelProcess();
        [SerializeField] private PanelCenter onPanelCentering = new PanelCenter();
        [SerializeField] private PanelCenter onPanelCentered = new PanelCenter();
